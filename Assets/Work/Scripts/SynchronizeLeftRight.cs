...
public class SynchronizeLeftRight : MonoBehaviour
{
    ...
    public SynchronizeLeftRight(GameObject _HMD, GameObject _mirrorHand, GameObject _originalHand, Vector3 _basePos)
    {
        HMD = _HMD;
    ...
    public void Update()
    {
        ...
        if (isMirror)
        {
            mirrorHand.transform.eulerAngles = new Vector3(angle.x, 360.0f - angle.y, 360.0f - angle.z + 180.0f);
        }
        else
        {
